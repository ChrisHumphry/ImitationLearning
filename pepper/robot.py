...
class Pepper:
    ...
    **Real robot controller**
    ...
    def __init__(self, ip_address, port=9559):
        ...
        self.vid_recorder_service = self.session.service("ALVideoRecorder")
        try:
            self.vid_recorder_service.stopRecording()
        except:
            pass
        self.vid_recorder_service.setResolution(2)
        self.vid_recorder_service.setFrameRate(10)
        self.vid_recorder_service.setVideoFormat("MJPG")
    ...
    def record_video(self, name, seconds=4):
        print("RECORDING")
        self.vid_recorder_service.startRecording("/home/nao/recordings/cameras", name)
        time.sleep(seconds)
        # Video file is saved on the robot in the
        # /home/nao/recordings/cameras/ folder.
        videoInfo = self.vid_recorder_service.stopRecording()
        print("Video was saved on the robot: ", videoInfo[1])
        print("Num frames: ", videoInfo[0])
        self.say("done", bodylanguage="disabled")
